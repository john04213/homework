...
//let appName = "PNC Mobile Bootcamp"
print(appName)
...
let summary = "\(transactionCount) transactions averaging \(String(format: "%.2f", averageTransaction)) "
print(summary)
print(divider)
...
for num in 1...20 where num.isMultiple(of: 2){
    print(num)
}
...
for account in accounts.enumerated(){
    print("\(account.offset + 1). \(account.element)")
}
print(divider)
// TODO 5e: while loop
